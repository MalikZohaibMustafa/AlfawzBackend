...
const allowedOrigins = ['http://localhost:3000', 'https://alfoaz.netlify.app', 'http://localhost:64732','http://alfawz.org'];
...
const PORT = process.env.PORT || 3000; // 3000 as default for local development
app.listen(PORT, () => {
